 ...
 */
     ...
     */
    enchant.nineleap = {};
    window.enchant.nineleap = enchant.nineleap;
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height, startImage, endImage) {
            ...
            this.addEventListener('load', function func() {
                var core = this;
                this.startScene = new enchant.nineleap.SplashScene();
                this.startScene.image = this.assets[this.startImage];
                this.startScene.addEventListener('touchend', function func() {
                    ...
                    this.removeEventListener('touchend', func);
                });
                this.addEventListener('keydown', function func() {
                ...
                this.endScene.image = this.assets[this.endImage];
...
const Core = enchant.nineleap.Core;
const SplashScene = enchant.nineleap.SplashScene;
export {
    Core,
    SplashScene,
};
