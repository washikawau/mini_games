...
enchant.avatar.AvatarBG = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(mode, avatarBg1, avatarBg2, avatarBg3) {
        ...
        for (let i = 0; i < 14; i++) {
            ...
            tile.image = core.assets[avatarBg1];
            tile.frame = mode;
            tile.x = i * 31 - 48;
            tile.y = 48;
...
const AvatarCharacter = enchant.avatar.AvatarCharacter;
const AvatarMonster = enchant.avatar.AvatarMonster;
const AvatarBG = enchant.avatar.AvatarBG;
const Avatar = enchant.avatar.Avatar;
export {
    AvatarCharacter,
    AvatarMonster,
    AvatarBG,
