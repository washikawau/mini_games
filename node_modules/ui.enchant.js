...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
     ...
     */
    initialize: function(padImage) {
        var core = enchant.Core.instance;
        var image = core.assets[padImage];
...
enchant.ui.APad = enchant.Class.create(enchant.Group, {
     ...
     */
    initialize: function(mode, padImage) {
        var core = enchant.Core.instance;
        var image = core.assets[padImage];
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
     ...
     * @param posY
     */
    initialize: function(x, y, fontImage, row) {
        ...
        this.text = '';
        if (arguments[3]) {
            this.row = Math.floor(arguments[3] / this.fontSize);
        }
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets[this.fontImage],
...
enchant.ui.ScoreLabel = enchant.Class.create(enchant.ui.MutableText, {
     ...
     * @param y
     */
    initialize: function(x, y, fontImage) {
        enchant.ui.MutableText.call(this, 0, 0, fontImage);
        this.x = x || 0;
        this.y = y || 0;
        this._score = 0;
        this._current = 0;
...
enchant.ui.TimeLabel = enchant.Class.create(enchant.ui.MutableText, {
     ...
     * @param counttype
     */
    initialize: function(x, y, fontImage, counttype) {
        enchant.ui.MutableText.call(this, 0, 0, fontImage);
...
enchant.ui.LifeLabel = enchant.Class.create(enchant.Group, {
     ...
     * @param maxlife
     */
    initialize: function(x, y, maxlife, iconImage) {
        enchant.Group.call(this);
        this.x = x || 0;
        this.y = y || 0;
        this._maxlife = maxlife || 9;
        this._life = 0;
        this.label = new enchant.ui.MutableText(0, 0, iconImage);
        this.addChild(this.label);
        this.heart = [];
        for (var i = 0; i < this._maxlife; i++) {
            this.heart[i] = new enchant.Sprite(16, 16);
            this.heart[i].image = enchant.Game.instance.assets[iconImage];
...
const Pad = enchant.ui.Pad;
const APad = enchant.ui.APad;
const Button = enchant.ui.Button;
const MutableText = enchant.ui.MutableText;
const ScoreLabel = enchant.ui.ScoreLabel;
const TimeLabel = enchant.ui.TimeLabel;
const LifeLabel = enchant.ui.LifeLabel;
const Bar = enchant.ui.Bar;
const VirtualMap = enchant.ui.VirtualMap;
export {
    Pad,
    APad,
    Button,
